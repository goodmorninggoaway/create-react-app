import { getUserProfile, getActiveTenant } from '@infosight/shell-api/lib/UserProfile';
import { getConfig } from '@infosight/shell-api/lib/Config';
import { SET_EXPERIMENTAL, SET_TENANT, SET_USER, USER_CONTEXT_CHANGED } from './constants';
