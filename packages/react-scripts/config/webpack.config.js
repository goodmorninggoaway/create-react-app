...
module.exports = function(webpackEnv) {
  ...
  return {
    ...
    output: {
      ...
      jsonpFunction: `webpackJsonp${appPackageJson.name.replace(
        /[@\-/]/g,
        ''
      )}`,
      // The JSONP function used by webpack for async loading of hot update chunks.
      // We need a unique name so that this does not conflict with other modules
      hotUpdateFunction: `webpackHotUpdate${appPackageJson.name.replace(
        /[@\-/]/g,
        ''
      )}`,
    ...
    plugins: [
      // InfoSight microapps should not generate html
